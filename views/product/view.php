                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            <?php if($product->new): echo \yii\helpers\Html::img("@web/images/product-details/new.jpg",['alt' => $product->name, 'class'=>'newarrival']); endif; ?>
                            <h2><?= $product->name ?></h2>

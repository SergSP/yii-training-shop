...
$this->beginPage() ?>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="#"><i class="fa fa-envelope"></i> info@shop.ru</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="<?= \yii\helpers\Url::home('https') ?>"><?= Html::img('/images/home/logo.png',['alt' => 'Логотип']) ?></a>
                        </div>
                    ...
                    <div class="col-sm-3">
                        <div class="search_box pull-right">
                            <form method="GET" action="<?= \yii\helpers\Url::to(['site/search']) ?>">
                                <input name="qsearch" type="text" placeholder="Search"/>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <?php \yii\bootstrap\Modal::begin([
        ...
        'footer' => '<button type="button" class="btn btn-danger pull-left" onclick="clearCart()">Очистить корзину</button>
